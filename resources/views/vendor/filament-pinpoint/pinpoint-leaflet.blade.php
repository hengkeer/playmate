{{--
    ...
    OVERRIDE: resources/views/vendor/filament-pinpoint/
    Changes:
      - Line 474: overflow:clip → overflow:hidden  (fixes map being clipped when search dropdown opens)
      - selectSearchResult(): added $nextTick + map.invalidateSize()
      - onSearchInput(): added $nextTick + map.invalidateSize() when clearing results
--}}
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    >
        ...
        @if ($isSearchable)
            <div style="position: relative; margin-bottom: 12px;">
                ...
                <div
                    ...
                    style="display: none; position: absolute; top: 100%; left: 0; right: 0; margin-top: 4px; border-radius: 8px; border: 1px solid #e5e7eb; max-height: 240px; overflow-y: auto; z-index: 9999; box-shadow: 0 4px 16px -2px rgba(0,0,0,0.18); background-color: #ffffff;"
        ...
        {{-- Map Container — FIX: overflow:hidden (was invalid "overflow:clip") --}}
        <div class="relative rounded-lg border border-gray-300 dark:border-gray-700" style="overflow: hidden;">
            <div
                x-ref="map"
    ...
    <style>
        ...
        /* Leaflet map z-index fix inside Filament — dropdown must sit above all map panes */
        ...
        /* Ensure the map container root is below the search dropdown (z-index 9999) */
